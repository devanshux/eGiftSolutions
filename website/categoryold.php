  ...
  <main class="mdl-layout__content">
	...
	<div class="sortbuttons">
		...
		if (isset($_GET["sortselect"]))
		{
			...
			$pagecount=0;
			$sqlpage="SELECT count(*) AS pagecount from inc_giftshop.products";
		...
		<div class="mdl-grid">
			...
			//{
			//	$p=$_GET["pagenumber"];
			//	$sql="SELECT * FROM inc_giftshop.products where products.category1 like '$categorysearch' or products.category2 like '$categorysearch' order by products.category1 asc limit $p,12";
		//		
			//}
