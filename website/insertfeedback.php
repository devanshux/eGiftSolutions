  ...
  <main class="mdl-layout__content">
    <div class="page-content"><!-- Your content goes here -->
		...
		if(isset($_POST["productfeedback"]))
		{
			...
			$sql="insert into giftshop.products_feedback (product_id,username,rating,comments) values ($pid,'$username',$rating,'$comments')";
		...
		else
		{
			...
			$rating=$_POST["rating"];
			$comments=$_POST["comments"];
			$sql="insert into giftshop.site_feedback (username,rating,comments) values ('$username',$rating,'$comments')";
			if ($conn->query($sql) === TRUE) {
			//echo "New record created successfully site";
			} else {
			echo "Each user can only submit feedback for a product once";
			}
		}
		$conn->close();
