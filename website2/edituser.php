...
<body>
  ...
  <main class="mdl-layout__content">
	...
	<div id='edituser'>
		...
		$sql="select username,password from big_giftshop.users where username='$username'";
		$userres=$conn->query($sql);
		$res=$userres->fetch_assoc();
		...
		<input class="mdl-textfield__input" type="text" value="<?php echo $password;?>" name="password">
		</div>
		<br>
		<input type="submit" class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary mybutton2' name="update" value="Update">
		<input type="submit" class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary mybutton2' name="delete" value="Delete">
		</form>
	</div>
	</div>
  </main>
