...
<body>
  ...
  <main class="mdl-layout__content">
	...
	$imgloc=$_POST["rotate"];
	$degrees=270;
	$gdimage=imagecreatefromjpeg($imgloc);
	$gdimage2=imagerotate($gdimage,$degrees,0);
	imagejpeg($gdimage2,$imgloc,99);
	echo "<a href='$imgloc'>".$imgloc."</a>";
	echo $id;
	echo "<script type='text/javascript'>alert('Image Rotated')</script>";
