...
<body>
  ...
  <main class="mdl-layout__content">
    <div class="page-content"><!-- Your content goes here -->
		...
		<?php
		$usersql="select username,password from big_giftshop.users";
		...
		while($row=$userres->fetch_assoc())
		{
			...
			echo "<td><button type='submit' class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary mybutton2' name='username' value='$user' form='user'>Edit</button></td></tr>";
		}
		?>
		</table>
		<br>
		<a href='adduser.php' class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary mybutton2'>Add User</a>
		</div>
